            ...
            _schema(
                ...
                "Start an issue/PR/ticket-driven coding workflow. Creates a tracked session, stores the trigger, and returns project memory: relevant decisions, lessons, errors, and search hits. Use before planning when the user gives a sparse issue or automation trigger.",
                {
                    ...
                    "properties": {
                        ...
                        "source_id": {"type": "string", "description": "Optional source namespace / tenant / agent id for shared-store scoping. If omitted, Hermes falls back to plugins.wg.source_id or WG_SOURCE_ID when set."},
            ...
            _schema(
                ...
                "Append a fact to the wiki. Always link to existing entities (call wg_entity_list first if unsure).",
                {
                    ...
                    "properties": {
                        ...
                        "source_id": {"type": "string", "description": "Optional source namespace / tenant / upstream id. If omitted, Hermes falls back to plugins.wg.source_id or WG_SOURCE_ID when set."},
                    },
                    "required": ["content"],
                },
            ),
