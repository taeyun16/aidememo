...
| Server / SSOT 목표 계약 | `crates/aidememo-domain` portable schema와 conformance fixture 구현, 나머지 server, PostgreSQL, artifact, client 경계는 제안 상태 | [`서버 및 SSOT 아키텍처`](SERVER_SSOT.md) |
