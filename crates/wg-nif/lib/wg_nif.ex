defmodule WgNif do
  @moduledoc """
  Elixir bindings for Wiki-Graph (`wg`) — a local knowledge-graph wiki backed
  ...
  ## Quick start
      ...
      ctx = WgNif.query(g, "Redis")          # unified context fetch
      hits = WgNif.search(g, "high availability", limit: 10)
      eid  = WgNif.entity_add(g, "Redis", entity_type: "technology")
      WgNif.fact_add(g, "Redis Sentinel provides HA", entity_ids: [eid])
