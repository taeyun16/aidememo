...
//! (`wg_aggregate sum_currency`, `wg_timeline range`) can compute
...
//! gets an in-house `wg-core/src/extract/ko.rs` module later — `interim`
...
/// to the reader for verification or to the agent for `wg_fact_get`
/// drill-in.
