defmodule AideMemoNif.Native do
  @moduledoc false
  # Low-level NIF stubs. Loaded from priv/libaidememo_nif.{so,dylib}.
  ...
  def load_nif do
    priv =
      case :code.priv_dir(:aidememo_nif) do
        {:error, :bad_name} ->
    ...
    path = Path.join(priv, "libaidememo_nif") |> String.to_charlist()
